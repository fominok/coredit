...
fn test_move_left_one_line() {
    ...
    let mut selection = SelectionRaw::new_quick(4, 10, 6, 20, CursorDirection::Forward);
    selection = selection.move_left(5, true, &line_length);
    assert_eq!(
        selection,
        SelectionRaw::new_quick(4, 10, 6, 15, CursorDirection::Forward),
    );
}
...
fn test_move_left_multiple_lines() {
    ...
    let mut selection = SelectionRaw::new_quick(2, 20, 6, 20, CursorDirection::Forward);
    selection = selection.move_left(80, true, &line_length);
    assert_eq!(
        selection,
        SelectionRaw::new_quick(2, 20, 4, 10, CursorDirection::Forward),
    );
}
...
fn test_move_left_one_line_and_one_char_more() {
    ...
    let mut selection = SelectionRaw::new_quick(3, 5, 3, 5, CursorDirection::Forward);
    selection = selection.move_left(5, false, &line_length);
    assert_eq!(
        selection,
        SelectionRaw::new_quick(2, 1, 2, 1, CursorDirection::Forward),
    );
}
...
fn test_move_left_multiple_lines_until_beginning() {
    ...
    let mut selection = SelectionRaw::new_quick(2, 20, 6, 20, CursorDirection::Backward);
    selection = selection.move_left(1337, true, &line_length);
    assert_eq!(
        selection,
        SelectionRaw::new_quick(1, 1, 6, 20, CursorDirection::Backward),
    );
}
...
fn test_move_left_one_line_until_beginning() {
    ...
    let mut selection = SelectionRaw::new_quick(1, 20, 1, 70, CursorDirection::Backward);
    selection = selection.move_left(1337, true, &line_length);
    assert_eq!(
        selection,
        SelectionRaw::new_quick(1, 1, 1, 70, CursorDirection::Backward),
    );
}
...
fn test_move_left_one_empty_line() {
    ...
    let mut selection = SelectionRaw::new_quick(1, 1, 1, 1, CursorDirection::Forward);
    selection = selection.move_left(1337, true, &line_length);
    assert_eq!(
        selection,
        SelectionRaw::new_quick(1, 1, 1, 1, CursorDirection::Forward),
    );
}
...
fn test_move_left_multiple_lines_reversed() {
    ...
    line_length.insert(5, 40);
    line_length.insert(4, 30);
    let mut selection = SelectionRaw::new_quick(5, 20, 6, 20, CursorDirection::Forward);
    selection = selection.move_left(80, true, &line_length);
    assert_eq!(
        selection,
        SelectionRaw::new_quick(4, 10, 5, 20, CursorDirection::Backward),
    );
}
...
fn test_move_right_one_line() {
    ...
    assert_eq!(
        selection,
        SelectionRaw::new_quick(4, 10, 6, 25, CursorDirection::Forward),
    );
}
...
fn test_move_right_multiple_lines() {
    ...
    assert_eq!(
        selection,
        SelectionRaw::new_quick(4, 10, 8, 25, CursorDirection::Forward),
    );
}
...
fn test_move_right_multiple_lines_until_end() {
    ...
    assert_eq!(
        selection,
        SelectionRaw::new_quick(4, 10, 8, 335, CursorDirection::Forward),
    );
}
...
fn test_move_right_one_line_until_end() {
    ...
    assert_eq!(
        selection,
        SelectionRaw::new_quick(1, 10, 1, 50, CursorDirection::Forward),
    );
}
...
fn test_move_right_multiple_lines_reversed() {
    ...
    line_length.insert(7, 35);
    line_length.insert(8, 335);
    let mut selection = SelectionRaw::new_quick(4, 10, 6, 20, CursorDirection::Backward);
    selection = selection.move_right(140, true, &line_length);
    assert_eq!(
        selection,
        SelectionRaw::new_quick(6, 20, 7, 10, CursorDirection::Forward),
    );
}
...
fn test_move_right_one_in_the_end() {
    let mut line_length = HashMap::new();
    line_length.insert(1, 30);
    let mut selection = SelectionRaw::new_quick(1, 10, 1, 30, CursorDirection::Forward);
    selection = selection.move_right(1, true, &line_length);
    assert_eq!(
        selection,
        SelectionRaw::new_quick(1, 10, 1, 30, CursorDirection::Forward),
    );
}
...
fn test_move_left_drop_selection() {
    ...
    assert_eq!(
        selection,
        SelectionRaw::new_quick(4, 10, 4, 10, CursorDirection::Forward),
    );
}
...
fn test_move_right_drop_selection() {
    ...
    assert_eq!(
        selection,
        SelectionRaw::new_quick(8, 25, 8, 25, CursorDirection::Forward),
    );
}
...
fn test_move_right_drop_selection_reversed() {
    ...
    assert_eq!(
        selection,
        SelectionRaw::new_quick(7, 10, 7, 10, CursorDirection::Forward),
    );
}
