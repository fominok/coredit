...
fn test_place_selections_under() {
    ...
    let selections_reference_vec = vec![
        SelectionUnbound::new_quick(4, 7, 4, 8, Default::default()),
        SelectionUnbound::new_quick(4, 76, 4, 77, Default::default()),
        SelectionUnbound::new_quick(4, 81, 4, 82, Default::default()),
        SelectionUnbound::new_quick(5, 7, 5, 8, Default::default()),
        SelectionUnbound::new_quick(6, 7, 6, 8, Default::default()),
        SelectionUnbound::new_quick(6, 76, 6, 77, Default::default()),
        SelectionUnbound::new_quick(6, 81, 6, 82, Default::default()),
    ];
